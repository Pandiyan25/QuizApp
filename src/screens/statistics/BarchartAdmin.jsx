...
const BarchartAdmin = () => {
  ...
  useEffect(() => {
    if (adminStats && adminStats?.graphs) {
      setUserGraphs1(
        adminStats?.graphs.length > 0 ? adminStats?.graphs[0].data : []
      );
      setUserGraphs2(
        adminStats?.graphs.length > 0 ? adminStats?.graphs[1].data : []
      );
      setUserGraphs3(
        adminStats?.graphs.length > 0 ? adminStats?.graphs[2].data : []
      );
    }
  ...
  return (
    <>
      ...
      <div>
        <h1 style={{ fontWeight: "bold", fontSize: "20px", padding: "30px" }}>
          Quiz Insights
        </h1>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div>
            ...
            >
              No.of students Qulified Vs Quiz
            </h1>
          </div>
        </div>
