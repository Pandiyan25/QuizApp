...
export default function Profile() {
  ...
  return (
    ...
    >
      {/* <div
        className="rounded-xl overflow-hidden px-5 shadow-xl grid items-center justify-center"
        style={{
      ...
      > */}
        <div
          className="flex flex-col items-center justify-center gap-8 md:gap-10 m-2 p-4 rounded-lg sm:p-4 md:p-8"
          style={{
        ...
        >
          <div className="text-3xl font-semibold sm:text-4xl md:text-5xl">Account Details</div>
          <div className="grid gap-4 w-[70vw]  md:w-[40vw]">
            <TextField
